            ...
            <BaseModalBody className="flex min-h-0 flex-1 flex-col !overflow-hidden">
              {body ? (
                <div className="flex min-h-0 flex-1 flex-col rounded-2xl border border-default-200 bg-default-100/60 overflow-hidden dark:border-zinc-700 dark:bg-zinc-800/60">
                  ...
                  <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3 pe-3 text-small text-default-600 leading-6 wrap-break-word custom-scrollbar dark:text-zinc-300">
                    <ReactMarkdown
                      ...
                      components={{
                        ...
                        ul: ({ children }) => (
                          <ul className="list-disc ps-6 my-2">{children}</ul>
                        ),
                        ol: ({ children }) => (
                          <ol className="list-decimal ps-6 my-2">{children}</ol>
                        ),

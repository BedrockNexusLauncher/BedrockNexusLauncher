...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div
      className={`fixed start-0 top-14 bottom-0 z-50 flex flex-col w-14 ${LAYOUT.NAVBAR_BG}`}
    >
      <div className="absolute end-0 top-[20px] bottom-0 w-px bg-default-200/50 dark:bg-zinc-800/50" />
      {/* Corner Connector */}
      <div className="absolute top-0 -end-[20px] w-[20px] h-[20px] overflow-hidden pointer-events-none">
        {/* Fill the corner gap */}
        <div
              ...
              <div className="relative group">
                {isActive && (
                  <motion.div
                    ...
                    className="absolute -start-2 top-1/2 -translate-y-1/2 w-1 h-8 rounded-e-full bg-linear-to-b from-primary-400 to-primary-600 shadow-[0_0_10px_rgba(var(--theme-500,16,185,129),0.45)]"
                    transition={{
                      type: "spring",
                      stiffness: 300,
                      damping: 30,
                ...
                <Button
                  ...
                  className={`w-12 h-12 rounded-xl transition-colors duration-200 ${
                    isActive
          ...
          themeMode !== "system" && (
            ...
            >
              <div>
                <ThemeSwitcher
                  isDisabled={navLocked}
                  className="w-12 h-12 rounded-xl text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 hover:bg-default-100 dark:hover:bg-zinc-800 transition-colors duration-200"
                  iconSize={20}
                />
              </div>
            </Tooltip>

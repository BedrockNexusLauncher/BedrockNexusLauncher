          ...
          <div className="flex flex-col gap-3 flex-1 justify-center">
            <div className="flex flex-col gap-1">
              ...
              <ColorSlider channel="hue" className="w-full touch-none">
                <SliderTrack className="h-4 w-full rounded-lg border border-default-200/50 relative overflow-hidden ring-offset-2 ring-offset-background focus-within:ring-2 focus-within:ring-primary-500 transition">

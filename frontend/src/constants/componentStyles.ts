export const COMPONENT_STYLES = {
  ...
  dropdownTriggerButton:
    "bg-default-100/50 dark:bg-zinc-800/50 data-[hover=true]:bg-default-200/50 dark:data-[hover=true]:bg-zinc-700/50 data-[focus=true]:border-primary-600 rounded-xl",
  listItem:
    "bg-white/60 dark:bg-zinc-950/65 border border-black/5 dark:border-white/10 shadow-sm hover:shadow-lg hover:bg-white/70 dark:hover:bg-zinc-900/70 rounded-3xl transition duration-300 ease-in-out transform hover:-translate-y-0.5",
  contentListItem:

                  ...
                  <div className="relative aspect-video bg-default-100/50 dark:bg-zinc-800/50 flex items-center justify-center overflow-hidden">
                    {s.dataUrl ? (
                      <>
                        ...
                        />
                        {!selection.isSelectMode && (
                          <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center bg-black/0 transition-colors duration-300 group-hover:bg-black/25">
                            <Button
                              size="sm"
                              radius="full"
                              variant="flat"
                              onPress={() => openPreview(s)}
                              className="pointer-events-auto flex items-center gap-2 border border-white/20 bg-black/45 px-3 py-1.5 text-xs font-medium text-white opacity-0 shadow-lg backdrop-blur-md transition duration-300 group-hover:opacity-100 hover:bg-black/55"
                            >
                              <FaExpand size={12} />
          ...
          {(onClose) => (
            <>
              <BaseModalHeader className="gap-3 pb-2 pt-7 sm:pt-6">
                <div className="flex items-start justify-between gap-4 pe-2 sm:pe-0">
              ...
              <BaseModalBody className="overflow-hidden px-4 py-3 sm:px-5">
                <div className="relative overflow-hidden rounded-[2rem] border border-black/5 bg-default-100/40 dark:border-white/10 dark:bg-zinc-900/40">
                  <div className="absolute inset-y-0 start-0 z-20 hidden items-center ps-3 sm:flex sm:ps-4">
                    <Button
                      isIconOnly
                      radius="full"
                      variant="flat"
                  ...
                  <div className="absolute inset-y-0 end-0 z-20 hidden items-center pe-3 sm:flex sm:pe-4">
                    <Button
                      isIconOnly
                      radius="full"
                      variant="flat"
                      ...
                      className="bg-white/75 text-default-700 shadow-lg backdrop-blur-md disabled:opacity-30 dark:bg-zinc-900/75 dark:text-zinc-100"
                    >
                      <FaChevronRight className="rtl:-scale-x-100" />
                    </Button>
                  </div>

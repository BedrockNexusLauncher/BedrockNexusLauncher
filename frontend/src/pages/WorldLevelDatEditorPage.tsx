    ...
    return function Box({
      ...
      return (
        <motion.div
          ...
          className="group relative overflow-hidden rounded-2xl border border-default-200 dark:border-default-100/10 bg-white/50 dark:bg-zinc-900/50 p-4 transition hover:bg-default-100 dark:hover:bg-zinc-800/50 hover:shadow-lg"
        >
            ...
            <PageHeader
              ...
              startContent={
                <Button
                  ...
                  onPress={() => navigate(-1)}
                >
                  <FaArrowLeft size={20} className="rtl:-scale-x-100" />
                </Button>
              }
              endContent={
                <>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <AnimatePresence>
                    {addOpen && (
                      ...
                      >
                        <div className="p-6 rounded-2xl bg-white/50 dark:bg-zinc-900/50 border border-default-200 dark:border-default-100/10 backdrop-blur-md shadow-sm">

                        ...
                        >
                          {isDownloaded(item) ? (
                            ...
                            <Button
                              ...
                              className="px-0 h-8 font-medium bg-default-100 dark:bg-zinc-700/50 text-default-700 dark:text-zinc-200 hover:bg-default-200 dark:hover:bg-zinc-600 transition-colors w-[120px]"
            ...
            {mirrorUrls && mirrorUrls.length > 0 ? (
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  {bestMirror ? (
                    <div
                      className={`group relative overflow-hidden flex items-center justify-between gap-4 rounded-2xl border-2 p-4 transition cursor-pointer ${
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {mirrorResults.map((m, i) => (
                      <div
                        key={`mirror-${i}`}
                        className={`relative flex items-center justify-between gap-3 rounded-xl border p-2.5 transition-colors cursor-pointer ${
                          selectedUrl === m.url

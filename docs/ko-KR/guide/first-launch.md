...
Bedrock Nexus를 처음 열 때, 앱은 Windows 및 Minecraft 환경이 호스팅 설치 요구 사항을 충족하는지 우선 확인합니다.

## 어떤 화면을 볼 수 있나요?

첫 실행 시 Bedrock Nexus는 다음과 같은 작업을 수행할 수 있습니다:
...
Gaming Services가 누락되었거나 손상된 경우, Bedrock Nexus는 Microsoft Store에서 설치하거나 복구하도록 안내할 수 있습니다.

...
This page explains what Bedrock Nexus needs before it can install and launch Minecraft Bedrock (GDK) versions correctly.
...
Bedrock Nexus may guide you through missing components during first launch or before installation.
...
3. Close the game before using Bedrock Nexus to install or manage versions.

## Installing Bedrock Nexus itself

### Option A: GitHub Releases page

Use this if you want the official Bedrock Nexus download page together with release notes and changelog context.

1. Open the [GitHub Releases](https://github.com/BedrockNexusLauncher/BedrockNexusLauncher/releases) page for Bedrock Nexus.
...
1. Open **Download** inside Bedrock Nexus.

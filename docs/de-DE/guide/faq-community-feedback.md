...
Ja. Bedrock Nexus ist explizit für die Verwendung mit der **originalen Minecraft Bedrock Edition (GDK)** konzipiert.
...
Ja. Bedrock Nexus bietet Übersichten für Welten, Ressourcenpakete, Verhaltenspakete, Skin-Pakete, Screenshots und Serverlisten.
...
- **GitHub Releases (offizieller Download):** [BedrockNexusLauncher/BedrockNexusLauncher Releases](https://github.com/BedrockNexusLauncher/BedrockNexusLauncher/releases)  
...
Bitte verwende [GitHub Issues](https://github.com/BedrockNexusLauncher/BedrockNexusLauncher/issues), um Folgendes zu melden:

- Reproduzierbare Fehler  
- Installationsprobleme, die eindeutig mit Bedrock Nexus zusammenhängen  

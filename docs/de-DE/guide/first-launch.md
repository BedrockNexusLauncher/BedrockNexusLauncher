...
Beim ersten Öffnen von Bedrock Nexus prüft die Anwendung zunächst, ob die Windows- und Minecraft-Umgebung die Anforderungen für eine verwaltete Installation erfüllt.

## Was du möglicherweise siehst

Beim ersten Start kann Bedrock Nexus Folgendes tun:
...
Falls Gaming Services fehlt oder beschädigt ist, leitet dich Bedrock Nexus möglicherweise zum Microsoft Store, um es zu installieren oder zu reparieren.

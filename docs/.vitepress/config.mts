...
const repo = "https://github.com/BedrockNexusLauncher/BedrockNexusLauncher";
...
export default defineConfig({
  title: "Bedrock Nexus",
  description:
    "User documentation for Bedrock Nexus, a desktop launcher for Minecraft Bedrock Edition (GDK) on Windows.",
  lang: "en-US",
  base,
  cleanUrls: true,
  lastUpdated: true,
  ...
  themeConfig: {
    ...
    footer: {
      copyright: "Copyright © 2024-2026 BedrockNexus",
    },
  },
  locales: {
    root: {
  ...
  sitemap: {
    hostname: "https://bedrocknexuslauncher.github.io/BedrockNexusLauncher/",
  },
});

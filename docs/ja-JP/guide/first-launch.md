...
Bedrock Nexus を初めて開いた際、アプリケーションは Windows および Minecraft 環境がホストインストールの要件を満たしているか確認を優先します。

## 何が表示されるか

初回起動時、Bedrock Nexus は以下の確認を行う場合があります：
...
Gaming Services が不足しているか破損している場合、Bedrock Nexus は Microsoft Store でのインストールまたは修復を促す場合があります。

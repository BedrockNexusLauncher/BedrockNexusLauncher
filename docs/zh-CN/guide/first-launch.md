...
第一次打开 Bedrock Nexus 时，应用会优先确认 Windows 与 Minecraft 环境是否满足托管安装要求。

## 你可能会看到什么

首次启动时，Bedrock Nexus 可能会：
...
如果 Gaming Services 缺失或损坏，Bedrock Nexus 可能会引导你去 Microsoft Store 安装或修复。

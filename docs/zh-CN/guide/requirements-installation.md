...
这一页说明 Bedrock Nexus 正常安装与管理 Minecraft Bedrock (GDK) 版本前，需要满足哪些条件。
...
首次启动或安装前，Bedrock Nexus 可能会引导你安装缺失组件。
...
3. 使用 Bedrock Nexus 安装或管理版本前，先关闭游戏。

## 安装 Bedrock Nexus 本体

### 方案 A：GitHub Releases 页面

适合希望直接从 Bedrock Nexus 官方下载页获取安装包，并顺便查看更新记录的用户。

1. 打开 Bedrock Nexus 的 [GitHub Releases](https://github.com/BedrockNexusLauncher/BedrockNexusLauncher/releases) 页面。
2. 下载安装程序。
3. 运行并完成安装向导。
...
1. 在 Bedrock Nexus 内打开 **Download**。

...
本頁說明在正常安裝及管理 Minecraft Bedrock (GDK) 版本前，Bedrock Nexus 需要滿足哪些條件。
...
首次啟動或安裝前，Bedrock Nexus 可能會引導你安裝缺失的組件。
...
3. 在使用 Bedrock Nexus 安裝或管理版本前，請先關閉遊戲。

## 安裝 Bedrock Nexus 主體

### 方案 A：GitHub Releases 頁面

適合希望直接從 Bedrock Nexus 官方下載頁獲取安裝程式，並順便查看更新記錄的用戶。

1. 開啟 Bedrock Nexus 的 [GitHub Releases](https://github.com/BedrockNexusLauncher/BedrockNexusLauncher/releases) 頁面。
2. 下載安裝程式。
3. 執行並完成安裝嚮導。
...
1. 在 Bedrock Nexus 內開啟 **Download**。

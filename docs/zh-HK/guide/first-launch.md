...
第一次開啟 Bedrock Nexus 時，應用程式會優先確認 Windows 與 Minecraft 環境是否滿足託管安裝要求。

## 你可能會看到什麼

首次啟動時，Bedrock Nexus 可能會：
...
如果 Gaming Services 缺失或損壞，Bedrock Nexus 可能會引導你前往 Microsoft Store 進行安裝或修復。

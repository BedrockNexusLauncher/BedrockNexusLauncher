...
Cette page décrit les conditions nécessaires pour que Bedrock Nexus puisse installer et gérer normalement les versions de Minecraft Bedrock (GDK).
...
Avant le premier lancement ou l'installation, Bedrock Nexus pourrait vous guider pour installer les composants manquants.
...
3. Fermez le jeu avant d'utiliser Bedrock Nexus pour installer ou gérer des versions.

## Installer Bedrock Nexus lui-même

### Option A : Page GitHub Releases

Convient aux utilisateurs souhaitant télécharger directement depuis la page officielle de Bedrock Nexus et consulter l'historique des mises à jour.

1. Ouvrez la page [GitHub Releases](https://github.com/BedrockNexusLauncher/BedrockNexusLauncher/releases) de Bedrock Nexus.
...
1. Dans Bedrock Nexus, ouvrez **Download**.

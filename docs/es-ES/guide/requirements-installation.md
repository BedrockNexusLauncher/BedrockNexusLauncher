...
Esta página explica los requisitos que deben cumplirse antes de que Bedrock Nexus pueda instalar y gestionar versiones de Minecraft Bedrock (GDK).
...
Antes del primer inicio o la instalación, Bedrock Nexus podría guiarte para instalar componentes que falten.
...
3. Cierra el juego antes de usar Bedrock Nexus para instalar o gestionar versiones.

## Instalar Bedrock Nexus

### Opción A: Página de GitHub Releases

Ideal para usuarios que quieren obtener el instalador directamente desde la página oficial de descargas de Bedrock Nexus y consultar el registro de cambios.

1. Abre la página de [GitHub Releases](https://github.com/BedrockNexusLauncher/BedrockNexusLauncher/releases) de Bedrock Nexus.
...
1. Abre **Download** en Bedrock Nexus.

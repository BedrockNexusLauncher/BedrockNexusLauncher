#ifndef AppName
  #define AppName "Bedrock Nexus"
#endif

#ifndef AppPublisher
  #define AppPublisher "BedrockNexus"
#endif
  ...
  #error "AppBinaryPath is required. Example: /DAppBinaryPath=C:\path\BedrockNexus.exe"
#endif
...
[Setup]
AppId=org.bedrocknexus.launcher
AppName={#AppName}
AppVersion={#AppVersion}
AppPublisher={#AppPublisher}
AppCopyright=(c) 2024-2026, BedrockNexus
...
VersionInfoCopyright=(c) 2024-2026, BedrockNexus
...
[Registry]
Root: HKCR; Subkey: ".mcpack"; ValueType: string; ValueName: ""; ValueData: "BedrockNexus.Content"; Flags: uninsdeletevalue
Root: HKCR; Subkey: ".mcaddon"; ValueType: string; ValueName: ""; ValueData: "BedrockNexus.Content"; Flags: uninsdeletevalue
Root: HKCR; Subkey: ".mcworld"; ValueType: string; ValueName: ""; ValueData: "BedrockNexus.Content"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "BedrockNexus.Content"; ValueType: string; ValueName: ""; ValueData: "Minecraft Bedrock Content"; Flags: uninsdeletekey
Root: HKCR; Subkey: "BedrockNexus.Content\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#AppExeName},0"; Flags: uninsdeletekey
Root: HKCR; Subkey: "BedrockNexus.Content\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#AppExeName}"" ""%1"""; Flags: uninsdeletekey
...
const
  ...
  CurrentInnoUninstallKey = 'Software\Microsoft\Windows\CurrentVersion\Uninstall\org.bedrocknexus.launcher_is1';
